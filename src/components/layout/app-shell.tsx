...
const NAV: NavItem[] = [
  ...
  { href: "/partners", label: "Partners & shares", icon: Handshake, adminOnly: true },
  { href: "/payments", label: "Fee payments", icon: Receipt },
  { href: "/payouts", label: "Partner payouts", icon: HandCoins },
  { href: "/expenses", label: "Company expenses", icon: ReceiptText, adminOnly: true },
